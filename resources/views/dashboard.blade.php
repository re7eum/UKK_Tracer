    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            <a href="#" class="brand-link">
                <img src="{{ asset('images/alumni.jpg') }}" alt="Logo Admin" class="brand-image img-circle elevation-3">
                <span class="brand-text font-weight-light">Tracer Alumni</span>
            </a>
            ...
            <div class="sidebar">
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        <li class="nav-item">
                            <a href="{{ route('dashboard') }}" class="nav-link active"> <!-- Menandai Dashboard sebagai aktif -->
                                <i class="nav-icon fas fa-tachometer-alt"></i>
                                <p>Dashboard</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('lowongan_alumni') }}" class="nav-link">
                                <i class="nav-icon fas fa-briefcase"></i>
                                <p>Lowongan kerja</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('universitas_terbaik') }}" class="nav-link">
                                <i class="nav-icon fas fa-university"></i>
                                <p>Universitas Terbaik</p>
                            </a>
                        </li>
                        @if (Auth::user()->role == 'admin')
                        <li class="nav-item mt-3"> <!-- Menambah margin atas -->
                            <a href="{{ route('admin.dashboard') }}" class="nav-link btn btn-secondary text-white"> <!-- Menggunakan kelas btn-secondary -->
                                <i class="nav-icon fas fa-arrow-left"></i> <!-- Ikon kembali -->
                        ...
                        <li class="nav-item has-treeview">
                            <a href="#" class="nav-link">
                                ...
                                <p>
                                    Lihat Data Pengisian
                                    <i class="right fas fa-angle-left"></i>
                                </p>
                            </a>
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('user.data_sekolah') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Data Sekolah</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('user.data_tahun_lulus') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Data Tahun Lulus</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('user.data_bidang_keahlian') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Data Bidang Keahlian</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('user.data_program_keahlian') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Data Program Keahlian</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('user.data_konsentrasi_keahlian') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Data Konsentrasi Keahlian</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('user.data_status_alumni') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Data Status Alumni</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('user.data_alumni') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Data Alumni</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('user.data_tracer_kuliah') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Data Tracer Kuliah</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('user.data_tracer_kerja') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Data Tracer Kerja</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('user.data_testimoni') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Data Testimoni</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item has-treeview">
                            <a href="#" class="nav-link">
                                <i class="fas fa-tasks nav-icon"></i> <!-- Ikon tugas -->
                                <p>
                                    Mengajukan Data yang Salah
                                    <i class="right fas fa-angle-left"></i>
                                </p>
                            </a>
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('permintaan_kuesioner_kuliah') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Data Kuesioner Kuliah</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('permintaan_kuesioner_kerja') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Data Kuesioner Kerja</p>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('penjelasan') }}" class="nav-link">
                                <i class="nav-icon fas fa-info-circle"></i> <!-- Ikon info -->
                                <p>Tentang Tracer Study</p>
                            </a>
                        </li>
                        <li class="nav-item mt-4"> <!-- Menambah margin atas -->
                            <form action="{{ route('logout') }}" method="POST">
                                @csrf
                                <button type="submit" class="btn btn-danger btn-block">
                                     <i class="fas fa-sign-out-alt"></i> Keluar <!-- Ikon keluar -->
                                </button>
                            </form>
                        </li>
                    </ul>
        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <h1 class="welcome-message">Selamat Datang di Halaman Alumni</h1>
                    <p id="welcome-message">Selamat Datang, {{ Auth::user()->name }}!</p>
                </div>
            </div>

            <!-- Menambahkan JavaScript untuk menghilangkan pesan setelah 5 detik -->
            <script>
                setTimeout(function() {
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-12 mb-4">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <p class="card-text">Lihat Data untuk beberapa tabel yang sudah mengisi</p>
                                    <a href="{{ route('statistik') }}" class="btn btn-primary btn-block">Masuk</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-12 mb-4">
                            <div class="card">
                                <div class="card-header">Kuesioner Kuliah</div>
                                <div class="card-body">
                                    <p class="card-text">Isi kuesioner untuk ingin melanjutkan kuliah demi masa depan yang baik.</p>
                                    <a href="{{ route('kuesioner_kuliah.index') }}" class="btn btn-primary btn-block">Isi Kuesioner Kuliah</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-12 mb-4">
                            <div class="card">
                                <div class="card-header">Kuesioner Kerja</div>
                                <div class="card-body">
                                    <p class="card-text">Isi kuesioner untuk melakukan pekerjaan yang baik.</p>
                                    <a href="{{ route('kuesioner_kerja.index') }}" class="btn btn-primary btn-block">Isi Kuesioner</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <footer class="main-footer">
            <p>&copy; 2025 Dashboard Alumni. Hak Cipta Dilindungi.</p>
        </footer>
        <!-- /.main-footer -->
    </div>
    <!-- ./wrapper -->

    <!-- AdminLTE JS dan dependensi -->
