...
<div class="container mt-5">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            {{-- Add Bidang Keahlian Button --}}
            <div class="d-flex justify-content-between align-items-center mb-3">
                 <a href="{{ route('bidang_keahlian.create') }}" class="btn btn-success"><i class="fas fa-plus-circle me-2"></i>Tambah Bidang Keahlian</a>
            </div>

            {{-- Search Form --}}
            <div class="search-form-container mb-3">
                <form class="d-flex" method="GET">
                    <input class="form-control me-2" type="search" name="search" placeholder="Cari Bidang Keahlian..." aria-label="Search" value="{{ request('search') }}">
            ...
            <table class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                    @forelse ($bidangKeahlian as $bidang)
                        <tr>
                            ...
                            <td>
                                <div class="action-buttons"> {{-- Container for action buttons --}}
                                    <a href="{{ route('bidang_keahlian.edit', $bidang) }}" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i> Edit</a>
                                    <form action="{{ route('bidang_keahlian.destroy', $bidang) }}" method="POST" class="d-inline" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data ini?');">
                                        @csrf
                                        @method('DELETE')
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="text-center">Data bidang keahlian tidak tersedia.</td> {{-- Adjusted colspan --}}
                        </tr>
                    @endforelse
                </tbody>
            </table>
