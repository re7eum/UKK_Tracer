...
<head>
    ...
    <title>Daftar Kuesioner Kerja</title>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <a href="{{ route('kuesioner_kerja.create') }}" class="btn btn-success"><i class="fas fa-plus-circle me-2"></i>Tambah Data</a>
                </div>
                @endif
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="action-buttons">
                                            @if (Auth::user()->role == 'admin')
                                                <a href="{{ route('kuesioner_kerja.edit', $kuesioner->id_kuesioner_kerja) }}" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i> Edit</a>
                                                <form action="{{ route('kuesioner_kerja.destroy', $kuesioner->id_kuesioner_kerja) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data ini?');">
                                                    @csrf
                                                    @method('DELETE')
                                            ...
                                            @endif
                                            @if (Auth::user()->role == 'user')
                                                <a href="{{ route('kuesioner_kerja.show', $kuesioner->id_kuesioner_kerja) }}"
                                                   class="btn btn-primary btn-sm"
                                                   onclick="event.preventDefault(); confirmSend('{{ route('kuesioner_kerja.show', $kuesioner->id_kuesioner_kerja) }}')">
