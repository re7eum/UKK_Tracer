    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                 <a href="{{ route('sekolah.create') }}" class="btn btn-success"><i class="fas fa-plus-circle me-2"></i>Tambah Sekolah</a>
            </div>

            {{-- Search Form --}}
            <div class="search-form-container mb-3">
                <form class="d-flex" method="GET">
                    <input class="form-control me-2" type="search" name="search" placeholder="Cari Sekolah..." aria-label="Search" value="{{ request('search') }}">
            ...
            <div class="table-responsive">
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="action-buttons"> {{-- Container for action buttons --}}
                                        <a href="{{ route('sekolah.edit', $sekolah) }}" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i> Edit</a>
                                        <form action="{{ route('sekolah.destroy', $sekolah) }}" method="POST" class="d-inline" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data ini?');">
                                            @csrf
                                            @method('DELETE')
                        ...
                        @empty
                            <tr>
                                <td colspan="9" class="text-center">Data sekolah tidak tersedia.</td> {{-- Adjusted colspan --}}
                            </tr>
                        @endforelse
                    </tbody>
                </table>
